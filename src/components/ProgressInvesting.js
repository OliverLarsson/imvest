  ...
  <Fragment>
    ...
    */}
          <Row>
              ...
              <Col>
              <CardText className="text-dark font-weight-light text-uppercase text-center" style={{ fontSize: '0.8rem' , paddingTop:'1rem'}}>Personal</CardText>
              </Col>
              <Col>
              ...
              <Col>
              <CardText className="text-success font-weight-bold text-uppercase text-center" style={{ fontSize: '0.8rem' , paddingTop:'1rem'}}>Investments</CardText>
              </Col>
          </Row>
  </Fragment>
);

export default ProgressInvesting;