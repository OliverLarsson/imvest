      ...
      <Fragment>
        { this.state.post && <div className="position-relative">
          ...
          <span className="d-block pb-2 mb-0 h6 text-uppercase text-info font-weight-bold">
            Our Mission
            <Badge pill color="success" className="text-uppercase px-2 py-1 ml-3 mb-1 align-middle" style={{ fontSize: '0.75rem' }}>Imvest Team</Badge>
          </span>
          
          <span className="d-block pb-4 h2 text-dark border-bottom border-gray">Investing made better, for everyone</span>
